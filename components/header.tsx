...
const Header = () => {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 mt-2 p-2">
            <DropdownMenuItem
              className="cursor-pointer py-2 px-3 rounded-md hover:bg-[#7A8CC0] hover:text-[#1B3376]"
      ...
      return (
        <div className="flex flex-col space-y-4">
          ...
          <button
            ...
            className="w-full px-4 py-3 text-gray-600 hover:text-[#1B3376] hover:bg-[#7A8CC0] rounded-lg font-medium text-sm transition-colors text-left"
          >
            Beskeder
          </button>
          <button
          ...
          <div className="border-t border-[#7A8CC0] my-2"></div>
          <button
            onClick={handleSignOut}
            className="w-full px-4 py-3 text-gray-600 hover:text-[#1B3376] hover:bg-[#7A8CC0] rounded-lg font-medium text-sm transition-colors text-left"
          >
  ...
  return (
    <header className="bg-[#1B3376] border-b border-[#7A8CC0]">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-lg text-white hover:bg-[#7A8CC0]/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"
            >
            ...
            {isLoading ? (
              ...
              <>
                <button 
                  ...
                  className="px-3 py-2 bg-[#472A1A] hover:bg-[#372010] text-white rounded-md font-medium transition-colors"
                >
                  Sælg nu
                </button>
                {renderAuthButtons()}
              ...
              <>
                ...
                <button 
                  onClick={() => router.push('/login')}
                  className="px-3 py-2 bg-white hover:bg-gray-100 text-[#1B3376] font-medium rounded-md transition-colors"
                >
                  Login
                </button>
              </>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#1B3376] border-t border-[#7A8CC0]">
          <div className="px-4 pt-2 pb-3 space-y-1">
            {mobileCategoryItems.map((category) => (
              <div key={category.name} className="border-b border-[#7A8CC0] pb-2">
                <button
                  className="flex justify-between items-center w-full px-4 py-3 text-white hover:text-white hover:bg-[#7A8CC0] rounded-lg font-medium text-sm transition-colors text-left"
                ...
                {expandedMobileCategory === category.name && (
                  <div className="pl-6 mt-1 space-y-1">
                    {category.subcategories.map((subcat) => (
                      <button
                        key={subcat}
                        className="block w-full text-left px-4 py-2 text-gray-200 hover:text-white hover:bg-[#7A8CC0] rounded-lg text-sm transition-colors"
                        onClick={() => {
          ...
          <div className="px-4 py-4 border-t border-[#7A8CC0]">
